...
public class AcessosInterceptor extends HandlerInterceptorAdapter {

    public static List<Acesso> acessos = new ArrayList<>(); // Guardando em memória somente para demonstração, não para uso real
